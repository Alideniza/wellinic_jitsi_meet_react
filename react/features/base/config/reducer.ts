 ...
 * JitsiMeetJS#init(). The app will download config.js from the Wellinic Meet
 ...
 * The app will download config.js from the Wellinic Meet deployment and take its
 ...
 * config.js from the Wellinic Meet deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = merge(
        ...
        // downloaded from the Wellinic Meet deployment because the former contains
