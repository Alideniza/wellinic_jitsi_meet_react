...
/**
 * Restores a Wellinic Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Wellinic Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Wellinic Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
