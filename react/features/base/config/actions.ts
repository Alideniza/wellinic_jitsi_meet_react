...
/**
 * Signals that the configuration (commonly known in Wellinic Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in Wellinic Meet as config.js)
...
/**
 * Stores a specific Wellinic Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Wellinic Meet config.js to store.
 * @returns {Function}
 */
