...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Wellinic Meet in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Wellinic Meet.
     *
    ...
    /**
     * Getter for the prejoin video element in Wellinic Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Wellinic Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Wellinic Meet
    ...
    /**
     * Removes the listeners and removes the Wellinic Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Wellinic Meet.
     *
     ...
     * Only applies to certain Wellinic Meet deploys.
