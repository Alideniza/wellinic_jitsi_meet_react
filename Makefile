...
ifeq ($(OS),Windows_NT)
        ...
        WEBPACK_DEV_SERVER = .\node_modules\.bin\webpack serve --mode development --host 0.0.0.0 --port 8080
else
    WEBPACK = ./node_modules/.bin/webpack
    WEBPACK_DEV_SERVER = ./node_modules/.bin/webpack serve --mode development --host 0.0.0.0 --port 8080
endif
