...
var config = {
    ...
    // Moves all Wellinic Meet 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Wellinic Meet) (e.g. https://meet.jit.si/someMeeting
